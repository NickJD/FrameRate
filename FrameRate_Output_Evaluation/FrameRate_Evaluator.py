...
if __name__ == "__main__":
    ...
    try:
        print("Number of sequences with an EggNOG Hit | With a COG | %\t"+str(c_eggnog_num_hits[1])+"|"+str(c_eggnog_num_hits[0])+"|"+str(round((c_eggnog_num_hits[1]/c_eggnog_num_hits[0])*100,2))+"\t"+
        str(nc_eggnog_num_hits[1])+"|"+str(nc_eggnog_num_hits[0])+"|"+str(round((nc_eggnog_num_hits[1]/nc_eggnog_num_hits[0])*100,2))+"\t"+
        str(CDS_num_hits[1])+"|"+str(CDS_num_hits[0])+"|"+str(round((CDS_num_hits[1]/CDS_num_hits[0])*100,2)))
